...
private:
	...
	void createTextureImageSTB(uint32_t meshIndex) {
		...
		createImage(texWidth, texHeight, 1, std::nullopt, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, textureImage[meshIndex], textureImageMemory[meshIndex]);
	...
	void createTextureSkyboxSTB(uint32_t meshIndex) {
		...
		createImage(texWidth, texHeight, 6, VK_IMAGE_CREATE_CUBE_COMPATIBLE_BIT, VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, textureImage[meshIndex], textureImageMemory[meshIndex]);
	...
	void createImage(uint32_t width, uint32_t height, uint32_t arrayLayers, std::optional<VkImageCreateFlags> flags, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) {
